...
gf-ud eval macro LAS en_ewt-ud-test.conllu out/ewt-structures-udpipe.conllu
cat en_pud-ud-test.conllu | udpipe --parse structures.udpipe >out/pud-structures-udpipe.conllu
gf-ud eval macro LAS en_pud-ud-test.conllu out/pud-structures-udpipe.conllu
